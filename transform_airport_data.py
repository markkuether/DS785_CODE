...
def set_fields():
    ...
    # Transformed fields
    trans_airports = ["Loc Id", "State Id", "Use", "Elevation",
...
def parse_runways(airport_id, runway_reader, runways, next_row):
    ...
    if the runways are desireable for the study.
    ...
    #Logic disabled to ensure all airports appear
    '''
    if all_runways:
...
start_path = "C:/Users/Mark/Documents/By_Subject/Data Science Masters/DS785/Code_Scripts"
...
print(f"Finished - {airport_count}")
